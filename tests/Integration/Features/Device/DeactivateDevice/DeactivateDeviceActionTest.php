...
namespace App\Tests\Integration\Features\Device\DeactivateDevice;

use App\Entity\Device;
use App\Features\Device\CreateDevice\CreateDeviceCommand;
use App\Features\Device\DeactivateDevice\DeactivateDeviceAction;
use Doctrine\Persistence\ManagerRegistry;
use Doctrine\Persistence\ObjectManager;
use PHPUnit\Framework\TestCase;
use Prophecy\PhpUnit\ProphecyTrait;

class DeactivateDeviceActionTest extends TestCase
{
    use ProphecyTrait;
    ...
    public function testInvokeAction()
    {
        ...
        $action = new DeactivateDeviceAction(
            $doctrine->reveal()
        );
